 ...
 */
public class IsNotMemberSpecification<T>  extends AbstractSpecification<T> {
    private final String property;
    private final Object object;

    private final ExampleCriteria.BooleanOperator type;

    public IsNotMemberSpecification(ExampleCriteria.BooleanOperator type, String property, Object object) {
    ...
    public Predicate toPredicate(From root, CriteriaQuery<?> query, CriteriaBuilder cb) {
        return cb.isNotMember(object, root.get(property));
    }
}
